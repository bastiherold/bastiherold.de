          ...
          <tbody>
            <tr>
              <td class="text-center">
                <div class="avatar">
                  <img src="/dashboard/img/avatars/1.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
            ...
            <tr>
              <td class="text-center">
                <div class="avatar">
                  <img src="/dashboard/img/avatars/2.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
            ...
            <tr>
              <td class="text-center">
                <div class="avatar">
                  <img src="/dashboard/img/avatars/3.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
              ...
              <td>
                <div class="clearfix">
                  <div class="float-left">      <strong>74%</strong>
                  </div>
                  <div class="float-right">
                    <small class="text-muted">Jun 11, 2015 - Jul 10, 2015</small>
                  </div>
            ...
            <tr>
              <td class="text-center">
                <div class="avatar">
                  <img src="/dashboard/img/avatars/4.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
            ...
            <tr>
              <td class="text-center">
                <div class="avatar">
                  <img src="/dashboard/img/avatars/5.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
                  <span class="avatar-status badge-success"></span>
                </div>
              </td>
              <td>
              ...
              <td>
                <div class="clearfix">
                  ...
                  <div class="float-right">
                    <small class="text-muted">Jun 11, 2015 - Jul 10, 2015</small>    </div>
                </div>
                <div class="progress progress-xs">
                  <div class="progress-bar bg-info" role="progressbar" style="width: 22%" aria-valuenow="22" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
